...
function App () {
  ...
  return (
    <>
      <Header />
      <main className='grid place-content-center mt-12'>
        <article className='flex flex-col items-center'>
          ...
          <article className='w-[90vw] h-[40vw] mt-16'>
            ...
            <div className='w-[90vw] h-[40%] bg-gradient-to-t from-neutral-foreground to-transparent absolute top-[36vw] z-20' />
